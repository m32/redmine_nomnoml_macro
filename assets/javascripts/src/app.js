...
*/
	...
	nomnomlapp.magnifyViewport = function (diff){
		zoomLevel = Math.min(10, zoomLevel + diff)
		sourceChanged()
	}

	nomnomlapp.resetViewport = function (){
		zoomLevel = 1
		offset = {x: 0, y: 0}
		sourceChanged()
	}

	nomnomlapp.toggleSidebar = function (id){
	...
	nomnomlapp.discardCurrentGraph = function (){
	...
	nomnomlapp.saveViewModeToStorage = function (){
		var question = 
	...
	nomnomlapp.exitViewMode = function (){
		window.location = './'
	}
